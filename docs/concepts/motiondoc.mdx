...
A **MotionDoc** is a Lottie-like — but **own** — animation document. It is produced by the
Figma plugin (Figma Motion → MotionDoc) and consumed by `@blinn-motion/core`. The format is
