/**
 * `<FottieView doc={...} />` — plays a MotionDoc with native React Native views.
 *
...
import { parseColor, rgbaToCss, type MotionDoc, type RenderNode } from "@fottie/core";
...
/** The imperative handle exposed via a ref on <FottieView/>. */
export type FottieHandle = FottieControls;

export interface FottieViewProps extends FottiePlaybackOptions {
...
export const FottieView = forwardRef<FottieHandle, FottieViewProps>(function FottieView(
